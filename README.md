...
View café items with prices in INR
...
Menu displayed with real-time USD → INR price conversion

Supports multiple items and quantities

Automatically calculates subtotal per item

Generates a clean and readable final bill
...
##Git clone
                  https://github.com/ritesh1289/-java-cafe-billing-/blob/main/Java_Cafe_Code
